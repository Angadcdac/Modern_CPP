//file operation using constructor
#include <iostream>
#include <fstream>
#include <string>
...
int main()
{
    ...
    outFile << "Embedded Software Engineer" << endl;
    ...
    /************************************************
     * 8. Open file using fstream Constructor
     *    Read + Write Mode
     ************************************************/
    ...
    if (file)
    {
        cout << "\nFile opened successfully in Read/Write mode." << endl;
